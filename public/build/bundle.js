    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a0, "href", "https://www.jaredwhalen.com/");
    			...
    			add_location(path0, file$7, 15, 10, 505);
    			attr_dev(g, "id", "tfnVb0.tif");
    			add_location(g, file$7, 14, 8, 475);
    			...
    			add_location(svg0, file$7, 13, 6, 368);
    			attr_dev(a1, "target", "_blank");
    			attr_dev(a1, "href", "https://twitter.com/jared_whalen");
    			add_location(a1, file$7, 12, 4, 302);
    			...
    			add_location(path1, file$7, 23, 8, 1641);
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t7 = space();
    			p2 = element("p");
    			t8 = text("See anything off? Have ideas on how to make this better? Send me an email at ");
    			a1 = element("a");
    			...
    			add_location(a1, file$6, 14, 82, 1157);
    ...
    */
    ...
    var shows = [
    	...
    	},
    	{
    		...
    		state: "MN",
    		url: [
    			"https://www.setlist.fm/setlist/mewithoutyou/2022/varsity-theater-minneapolis-mn-3bb7cc64.html"
    		],
    		setlist: [
    			{
    				name: "[Untitled]",
